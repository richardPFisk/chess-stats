...
use crate::components::{
    black_bishop::BlackBishop, black_king::BlackKing, black_knight::BlackKnight, black_pawn::BlackPawn, black_queen::BlackQueen, black_rook::BlackRook, white_bishop::WhiteBishop, white_king::WhiteKing, white_knight::WhiteKnight, white_pawn::WhitePawn, white_queen::WhiteQueen, white_rook::WhiteRook
};
